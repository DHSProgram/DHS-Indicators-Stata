...
label var ml_fev_govh "Fever treatment sought from government hospital among children with fever"

gen ml_fev_govh_trt=0 if ml_fev_care==1
replace ml_fev_govh_trt=1 if ml_fev_care==1 & h32a==1
replace ml_fev_govh_trt =. if b5==0
label var ml_fev_govh_trt "Fever treatment sought from government hospital among children with fever that sought treatment"
...
label var ml_fev_govcent "Fever treatment sought from government health center among children with fever"

gen ml_fev_govcent_trt=0 if ml_fev_care==1
replace ml_fev_govcent_trt=1 if ml_fev_care==1 & h32b==1
replace ml_fev_govcent_trt =. if b5==0
label var ml_fev_govcent_trt "Fever treatment sought from government health center among children with fever that sought treatment"

//Fever treatment from a private hospital/clinic
gen ml_fev_pclinc=0 if ml_fever==1
replace ml_fev_pclinc=1 if ml_fever==1 & h32j==1
replace ml_fev_pclinc =. if b5==0
label var ml_fev_pclinc "Fever treatment sought from private hospital/clinic among children with fever"

gen ml_fev_pclinc_trt=0 if ml_fev_care==1
replace ml_fev_pclinc_trt=1 if ml_fev_care==1 & h32j==1
replace ml_fev_pclinc_trt =. if b5==0
label var ml_fev_pclinc_trt "Fever treatment sought from private hospital/clinic  among children with fever that sought treatment"
...
gen ml_fev_pdoc_trt=0 if ml_fev_care==1
replace ml_fev_pdoc_trt=1 if ml_fev_care==1 & h32l==1
...
gen ml_fev_pharm_trt=0 if ml_fev_care==1
replace ml_fev_pharm_trt=1 if ml_fev_care==1 & h32k==1
...
foreach x in a aa ab b c d da e f g h {
	replace ml_antimal=1 if ml13`x'==1
	}
...
replace ml_sp_fan=1 if ml13a==1
...
replace ml_chloro=1 if ml13b==1
...
replace ml_amodia=1 if ml13c==1
...
replace ml_quin_pill=1 if ml13d==1
...
replace ml_quin_inj=1 if ml13da==1
...
replace ml_artes_rec=1 if ml13aa==1
...
replace ml_artes_inj=1 if ml13ab==1
...
replace ml_antimal_other=1 if ml13h==1
