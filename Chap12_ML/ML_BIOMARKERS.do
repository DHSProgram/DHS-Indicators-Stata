...
Date last modified:Date last modified: September 6, 2024 by Courtney Allen
*****************************************************************************************************/
...
//Tested for Anemia
gen ml_test_anemia=0 if hv120==1 & hv103==1 & hc1>=6 & hc1<=59 & hv042==1
replace ml_test_anemia=1 if hv120==1 & hc55==0
label var ml_test_anemia "Tested for anemia in children 6-59 months"

//Tested for Parasitemia via microscopy
gen ml_test_micmal=0 if hv120==1 & hv103==1 & hc1>=6 & hc1<=59 & hv042==1
replace ml_test_micmal=1 if hv120==1 & (hml32==0 | hml32==1 | hml32==6)
label var ml_test_micmal "Tested for Parasitemia (via microscopy) in children 6-59 months"

//Tested for Parasitemia via RDT
gen ml_test_rdtmal=0 if hv120==1 & hv103==1 & hc1>=6 & hc1<=59 & hv042==1
replace ml_test_rdtmal=1 if hv120==1 & (hml35==0 | hml35==1)
