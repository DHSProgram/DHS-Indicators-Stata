/*******************************************************************************************************************************
Program: 				RCmaster.do
Purpose: 				Master file for the Respondents' Characteristics Chapter. 
						The master file will call other do files that will produce the RC indicators and produce tables.
