...
**SET UP COVARIATES, LABELS
	...
	clonevar marital = v502
	label var marital "marital status"
	clonevar afraid = d129
	clonevar husb_edu	= v701
	clonevar father_beat = d121
	
	label define NA 0 "NA" //for sub groups where no median can be defined
	label define yesno 0 "no" 1 "yes" //for all yes/no binary variables
	...
	local subgroup residence region marital work livingchild education wealth 
