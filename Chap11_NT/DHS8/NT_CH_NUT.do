...
Purpose: 			Code to compute anthropometry and anemia indicators in children - DHS8 update
Data inputs: 		PR dataset
Data outputs:		coded variables
Author:				Shireen Assaf
Date last modified: November 7, 2022 by Shireen Assaf 
Note:				
*****************************************************************************************************/
...
nt_ch_ovwt			"Overweight child under 5 years"
...
//Overweight 
gen nt_ch_ovwt= 0 if hv103==1
replace nt_ch_ovwt=. if hc72>=9996
replace nt_ch_ovwt=1 if hc72>200 & hc72<9996 & hv103==1 
