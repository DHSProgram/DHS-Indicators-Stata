...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_bcg_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//DPT1
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_pent1_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//DPT2
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_pent2_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//DPT3
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_pent3_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Polio0
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_polio0_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Polio1
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_polio1_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Polio2
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_polio2_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Polio3
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_rotav1_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Rotavirus2
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_rotav2_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Rotavirus3
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_rotav3_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Measles
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_meas_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//All basic vaccinations
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_allvac_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//No vaccinations
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_novac_either using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
**************************************************************************************************
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_card_ever_had using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
//Vaccination card seen
...
* output to excel
tabout b4 birth_order ch_card_seen v025 v106 v024 v190 ch_card_seen using Tables_Vac.xls [iw=wt], c(row) f(1) append 
*/
****************************************************
